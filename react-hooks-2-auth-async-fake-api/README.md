...
DEMO: [https://react-hooks-ja1889s3n.now.sh](https://react-hooks-ja1889s3n.now.sh)

**Цель**: выяснить уровень знаний React/React-hooks/React-Router. Уровень работы с асинхронными запросами. Понимание взаимодействия клиента и сервера.
...
Полученные данные отрисовать на странице следующим образом:
